                    ...
                    <div class="etn-settings-tab-content">
                        <div class="etn-settings-tab" id="events-details">                           
                            ...
                            <div class="attr-form-group etn-label-item">
                                ...
                                <div class="etn-meta">
                                    <input id="disable_rich_snippets_for_event" type="checkbox" <?php echo esc_html($disable_rich_snippets_for_event); ?> class="etn-admin-control-input" name="disable_rich_snippets_for_event" />
                                    <label for="disable_rich_snippets_for_event" class="etn_switch_button_label"></label>
                                </div>
                            </div>
                            <?php
